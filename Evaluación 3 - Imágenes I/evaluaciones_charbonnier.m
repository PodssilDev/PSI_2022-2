% Evaluaciones para el filtro de difusión anisotrópica con la función de 
% difusión de Charbonnier
...
% Se realiza el llamado a la función de Charbonnier con distintas iteraciones
imagen_salida1_1 = difusion_anisotropica(imagen1,10,0.25,10,3);
imagen_salida1_2 = difusion_anisotropica(imagen1,20,0.25,10,3);
imagen_salida1_3 = difusion_anisotropica(imagen1,30,0.25,10,3);
imagen_salida1_4 = difusion_anisotropica(imagen1,40,0.25,10,3);
imagen_salida1_5 = difusion_anisotropica(imagen1,50,0.25,10,3);
...
sgtitle('Charbonnier: Lambda = 0.25, K = 10') 
...
% Se realiza el llamado a la función de Charbonnier con distinto K
imagen_salida2_1 = difusion_anisotropica(imagen2,30,0.25,10,3);
imagen_salida2_2 = difusion_anisotropica(imagen2,30,0.25,20,3);
imagen_salida2_3 = difusion_anisotropica(imagen2,30,0.25,30,3);
imagen_salida2_4 = difusion_anisotropica(imagen2,30,0.25,40,3);
imagen_salida2_5 = difusion_anisotropica(imagen2,30,0.25,50,3);
...
sgtitle('Charbonnier: Iteraciones = 30, Lambda = 0.25');
...
% Se realiza el llamado a la función de Charbonnier con distinto Lambda,
% respetando que solo puede tomar valores hasta 0.25
imagen_salida3_1 = difusion_anisotropica(imagen3,30,0.05,10,3);
imagen_salida3_2 = difusion_anisotropica(imagen3,30,0.10,10,3);
imagen_salida3_3 = difusion_anisotropica(imagen3,30,0.15,10,3);
imagen_salida3_4 = difusion_anisotropica(imagen3,30,0.20,10,3);
imagen_salida3_5 = difusion_anisotropica(imagen3,30,0.25, 10,3);
...
sgtitle('Charbonnier: Iteraciones = 30, k = 10');
...
for n_plot = 1:5
    ...
    % Se realiza el llamado a la función de Perona-Malik 2 con los valores aleatorios
    imagen4_salida = difusion_anisotropica(imagen4, iteraciones_aleatorias, lambda_aleatorio, k_aleatorio, 3);

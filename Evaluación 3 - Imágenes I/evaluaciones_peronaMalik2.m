% Evaluaciones para el filtro de difusión anisotrópica con la segunda
...
% Se realiza el llamado a la función de Perona-Malik 2 con distintas
% iteraciones
imagen_salida1_1 = difusion_anisotropica(imagen1,10,0.25,10,2);
imagen_salida1_2 = difusion_anisotropica(imagen1,20,0.25,10,2);
imagen_salida1_3 = difusion_anisotropica(imagen1,30,0.25,10,2);
imagen_salida1_4 = difusion_anisotropica(imagen1,40,0.25,10,2);
imagen_salida1_5 = difusion_anisotropica(imagen1,50,0.25,10,2);
...
sgtitle('Perona-Malik 2: Lambda = 0.25, K = 10') 
...
% Se realiza el llamado a la función de Perona-Malik 2 con distinto K
imagen_salida2_1 = difusion_anisotropica(imagen2,30,0.25,10,2);
imagen_salida2_2 = difusion_anisotropica(imagen2,30,0.25,20,2);
imagen_salida2_3 = difusion_anisotropica(imagen2,30,0.25,30,2);
imagen_salida2_4 = difusion_anisotropica(imagen2,30,0.25,40,2);
imagen_salida2_5 = difusion_anisotropica(imagen2,30,0.25,50,2);
...
sgtitle('Perona-Malik 2: Iteraciones = 30, Lambda = 0.25');
...
% Se realiza el llamado a la función de Perona-Malik 2 con distinto Lambda,
% respetando que solo puede tomar valores hasta 0.25
imagen_salida3_1 = difusion_anisotropica(imagen3,30,0.05,10,2);
imagen_salida3_2 = difusion_anisotropica(imagen3,30,0.10,10,2);
imagen_salida3_3 = difusion_anisotropica(imagen3,30,0.15,10,2);
imagen_salida3_4 = difusion_anisotropica(imagen3,30,0.20,10,2);
imagen_salida3_5 = difusion_anisotropica(imagen3,30,0.25, 10,2);
...
sgtitle('Perona-Malik 2: Iteraciones = 30, k = 10');
...
for n_plot = 1:5
    ...
    imagen4_salida = difusion_anisotropica(imagen4, iteraciones_aleatorias, lambda_aleatorio, k_aleatorio, 2);
    ...
    % el filtro de difusión anisotropica con Perona-Malik 2
    subplot(3,2,n_plot+1), imshow(imagen4_salida), title(string(n_plot+1) + '. ' + titulo);
end
% Se establece el titulo general del subgrafico.
sgtitle('Perona-Malik 2: Distintos valores para Iteraciones, Lambda y K');